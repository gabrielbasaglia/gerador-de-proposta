  ...
  return (
    <main className="flex items-center flex-col justify-center min-h-[calc(100vh-10rem)]">
      <p className="text-center">
        ...
        desejados.O uso continuado de nosso site será considerado como aceitação
        de nossas práticas em torno de privacidade e informações pessoais. Se
        você tiver alguma dúvida sobre como lidamos com dados do usuário e
        informações pessoais, entre em contacto connosco.O serviço Google
        AdSense que usamos para veicular publicidade usa um cookie DoubleClick
        para veicular anúncios mais relevantes em toda a Web e limitar o número
        ...
        propostamp oferece no site e com caráter enunciativo, mas não
        ...
        conteúdo de natureza racista, xenofóbica, kiwibet ou azar, qualquer tipo
        de pornografia ilegal, de apologia ao terrorismo ou contra os direitos
        humanos;C) Não causar danos aos sistemas físicos (hardwares) e lógicos
        (softwares) do propostamp, de seus fornecedores ou terceiros, para
        ...
        mencionados.Mais informaçõesEsperemos que esteja esclarecido e, como
        ...
        caso interaja com um dos recursos que você usa em nosso site.Esta
        política é efetiva a partir de 28 January 2024 02:09
      </p>
    </main>
  );
}
