  ...
  return (
    <main className="mx-10 p4 mt-5">
      ...
      <p className="text-gray-700">
        ...
        possamos coletar no site Propostasmp, e outros sites que possuímos e
        operamos.
      </p>
      ...
      <p className="text-gray-700">
        ...
        <a
          href="https://support.google.com/adsense/answer/6242051?hl=pt-BR"
      ...
      <p className="text-gray-700">
        ...
        parceiros afiliados ofereçam qualquer promoção que possa fornecê-lo para
        fazer uma compra.
      </p>
      ...
      <ol className="list-decimal pl-6 text-gray-700">
        ...
        <li>
          ...
          (softwares) do Propostasmp, de seus fornecedores ou terceiros, para
      ...
      <p className="text-gray-700 mt-4">
        Mais informações: Esperamos que esteja esclarecido e, como mencionado
      ...
      <p className="text-gray-700 mt-4">
        Esta política é efetiva a partir de 28 de janeiro de 2024 às 03:06.
      </p>
    </main>
  );
}
